 ...
 * Si el hotspot define `cielo`, también cambia el skybox 360 de la zona.
 */
AFRAME.registerComponent('teletransporte', {
  schema: {
    destino: { type: 'vec3' },
    cielo: { default: '' }   // selector del <img> en a-assets, ej: #cielo-panorama
  },
  ...
  init: function () {
    ...
    el.addEventListener('click', () => {
      ...
      if (this.data.cielo) {
        document.querySelector('a-sky').setAttribute('src', this.data.cielo);
      }
    });
